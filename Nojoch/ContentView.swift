    ...
    var body: some View {
                    ...
                    mainView()
                        .tabItem {
                            Label("Inicio", systemImage: "house.fill")
                                .accessibility(label: Text("Inicio"))
                        }
                    
                    exploreView()
                        .tabItem {
                            Label("Explora", systemImage: "binoculars")
                                .accessibility(label: Text("Explora"))
                        }
                    
                    miHerenciaView()
                        .tabItem {
                            Label("Herencia", systemImage: "medal")
                                .accessibility(label: Text("Mi herencia"))
                        }
        ...
        .onAppear {
            ...
            if patrimonios.isEmpty {
                ...
                modelContext.insert(Patrimonio(id: 10, tags: ["Urbano", "Historia", "Patrimonio", "Cultura", "Arqueología", "Centro Histórico"], persona: "Historiador del Centro", personaFoto: "person2", estado: "Estado de México", comunidad: "Cuauhtémoc", titulo: "Templo Mayor", descripcion: "Descubre uno de los principales templos del antiguo México-Tenochtitlán, un sitio arqueológico fundamental en la historia de la civilización mexica.", coordinates: [19.434710485493135, -99.13185603852551], ubicacion: "Centro Histórico, CDMX", fotos: ["temploMayor1", "temploMayor2", "temploMayor3"], idioma: "Náhuatl", favorited: false, visited: false, estrella: 5, insignia: "vase"))
            }
            if estados.isEmpty {
