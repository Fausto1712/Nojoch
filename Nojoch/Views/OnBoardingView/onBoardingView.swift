        ...
        .onChange(of: pageState){
            if pageState == 4 {
                ...
                if patrimonios.isEmpty {
                    modelContext.insert(Patrimonio(id: 0, tags: ["Hike", "Aventura", "Agua"], persona: "La Cumbre Cotidiana", personaFoto: "person5", estado: "Nuevo León", comunidad: "Puerto Genovevo", titulo: "Cañon Matacanes", descripcion: "Embarcate en una aventura extrema en uno de los cañones mas famosos de Mexico, con saltos de mas 12 metros, toboganes de agua, espeologia y mucho mas", coordinates: [25.371573866134465, -100.15547982938328], ubicacion: "Cola de caballo", fotos: ["matacanes1", "matacanes2", "matacanes3"], idioma: "Náhuatl", favorited: false, visited: false, esterellas: 5))
                    
                    modelContext.insert(Patrimonio(id: 1, tags: ["Hike", "Cultura", "Montaña"], persona: "Explorador de Raíces", personaFoto: "person2", estado: "Nuevo León", comunidad: "El Salto", titulo: "Cerro de la Silla", descripcion: "Sube al icónico cerro que vigila la ciudad de Monterrey y conecta con la historia y cultura local, mientras disfrutas de vistas impresionantes.", coordinates: [25.612250, -100.278030], ubicacion: "El Salto, Nuevo León", fotos: ["cerro1", "cerro2", "cerro3"], idioma: "Huasteco", favorited: false, visited: false, esterellas: 4))

                    modelContext.insert(Patrimonio(id: 2, tags: ["Aventura", "Agua", "Naturaleza"], persona: "Aventurero Silvestre", personaFoto: "person3", estado: "Nuevo León", comunidad: "Cieneguilla", titulo: "Río Pilón", descripcion: "Explora las cristalinas aguas del Río Pilón, un lugar perfecto para practicar senderismo y nadar en un entorno natural virgen.", coordinates: [25.343784, -99.891594], ubicacion: "Cieneguilla, Nuevo León", fotos: ["pilon1", "pilon2", "pilon3"], idioma: "Otomí", favorited: false, visited: false, esterellas: 5))

                    modelContext.insert(Patrimonio(id: 3, tags: ["Cultura", "Historia", "Rural"], persona: "Historias del Norte", personaFoto: "person4", estado: "Nuevo León", comunidad: "Galeana", titulo: "La Poza de la Gloria", descripcion: "Visita este lugar lleno de historia, conocido por haber sido un refugio durante la Guerra de Reforma, rodeado de naturaleza.", coordinates: [24.836251, -100.104105], ubicacion: "Galeana, Nuevo León", fotos: ["poza1", "poza2", "poza3"], idioma: "Totonaco", favorited: false, visited: false, esterellas: 4))

                    modelContext.insert(Patrimonio(id: 4, tags: ["Aventura", "Cuevas", "Exploración"], persona: "Guía Subterráneo", personaFoto: "person5", estado: "Nuevo León", comunidad: "Bustamante", titulo: "Grutas de Bustamante", descripcion: "Adéntrate en las profundas y misteriosas grutas, un viaje subterráneo que te llevará a descubrir formaciones naturales increíbles.", coordinates: [26.540776, -100.499512], ubicacion: "Bustamante, Nuevo León", fotos: ["grutas1", "grutas2", "grutas3"], idioma: "Náhuatl", favorited: false, visited: false, esterellas: 5))

                    modelContext.insert(Patrimonio(id: 5, tags: ["Cultura", "Tradición", "Rural"], persona: "Cronista Regional", personaFoto: "person6", estado: "Nuevo León", comunidad: "Aramberri", titulo: "Pueblo Mágico de Aramberri", descripcion: "Descubre las leyendas y tradiciones de este tranquilo pueblo, conocido por sus antiguas haciendas y artesanías tradicionales.", coordinates: [24.039659, -99.800330], ubicacion: "Aramberri, Nuevo León", fotos: ["aramberri1", "aramberri2", "aramberri3"], idioma: "Huichol", favorited: false, visited: false, esterellas: 4))

                    modelContext.insert(Patrimonio(id: 6, tags: ["Aventura", "Escalada", "Montaña"], persona: "Escalador Extremo", personaFoto: "person7", estado: "Nuevo León", comunidad: "Potrero Chico", titulo: "Escalada en Potrero Chico", descripcion: "Disfruta de uno de los mejores sitios de escalada en México, donde los acantilados de roca caliza ofrecen retos únicos para todos los niveles.", coordinates: [25.964460, -100.455560], ubicacion: "Potrero Chico, Hidalgo", fotos: ["potrero1", "potrero2", "potrero3"], idioma: "Totonaco", favorited: false, visited: false, esterellas: 5))

                    modelContext.insert(Patrimonio(id: 7, tags: ["Cultura", "Aventura", "Bosque"], persona: "Guardian de la Sierra", personaFoto: "person8", estado: "Nuevo León", comunidad: "Zaragoza", titulo: "Sierra de Zaragoza", descripcion: "Un lugar donde se mezclan la cultura indígena y la naturaleza salvaje, ideal para practicar senderismo en medio de exuberantes paisajes boscosos.", coordinates: [23.987345, -99.771441], ubicacion: "Zaragoza, Nuevo León", fotos: ["zaragoza1", "zaragoza2", "zaragoza3"], idioma: "Maya", favorited: false, visited: false, esterellas: 4))

                    modelContext.insert(Patrimonio(id: 8, tags: ["Aventura", "Ciclismo", "Naturaleza"], persona: "Ciclista de la Montaña", personaFoto: "person2", estado: "Nuevo León", comunidad: "San José de las Boquillas", titulo: "Ruta Ciclista Montemorelos", descripcion: "Una travesía en bicicleta a través de los paisajes montañosos de Montemorelos, perfecta para los amantes del ciclismo de montaña.", coordinates: [25.198034, -99.828610], ubicacion: "San José de las Boquillas, Montemorelos", fotos: ["montemorelos1", "montemorelos2", "montemorelos3"], idioma: "Purépecha", favorited: false, visited: false, esterellas: 5))

                    modelContext.insert(Patrimonio(id: 9, tags: ["Cultura", "Arqueología", "Montaña"], persona: "Arqueólogo del Norte", personaFoto: "person1", estado: "Nuevo León", comunidad: "Rayones", titulo: "Sitio Arqueológico El Sabinito", descripcion: "Explora este antiguo sitio arqueológico rodeado de montañas, testimonio de las primeras civilizaciones que habitaron el noreste de México.", coordinates: [25.180836, -100.195612], ubicacion: "Rayones, Nuevo León", fotos: ["sabinito1", "sabinito2", "sabinito3"], idioma: "Nahuatl", favorited: false, visited: false, esterellas: 5))
                }
                if estados.isEmpty {
