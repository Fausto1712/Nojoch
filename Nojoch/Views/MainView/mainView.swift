    ...
    var body: some View {
        ...
        .onAppear{
            ...
            if estados.isEmpty {
                ...
                modelContext.insert(Estado(id: 10, nombre: "Guanajuato", icono: "Im11", fotos: ["GTO1", "GTO2", "GTO3"], ubicacion: "Centro de México"))
                modelContext.insert(Estado(id: 11, nombre: "Guerrero", icono: "Im12", fotos: ["GRO1", "GRO2", "GRO3"], ubicacion: "Suroeste de México"))
                modelContext.insert(Estado(id: 12, nombre: "Hidalgo", icono: "Im13", fotos: ["HGO1", "HGO2", "HGO3"], ubicacion: "Centro de México"))
                modelContext.insert(Estado(id: 13, nombre: "Jalisco", icono: "Im14", fotos: ["JAL1", "JAL2", "JAL3"], ubicacion: "Oeste de México"))
                modelContext.insert(Estado(id: 14, nombre: "Estado de México", icono: "Im15", fotos: ["MEX1", "MEX2", "MEX3"], ubicacion: "Centro de México"))
